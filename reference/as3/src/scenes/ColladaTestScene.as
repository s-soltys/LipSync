package scenes
{
	...
	public class ColladaTestScene extends Sprite
	{
		...
		public function ColladaTestScene(){
			Debug.active = true;
		...
		private function onComplete(e:Event):void {
			...
			avatar.saySentences(["../lib/amy_aeiou.mp3"]);
			//addRefresh();
		...
		private function onLoadXML(e:Event):void {
			...
			for (var i:int = 0; i < 10; i++)
				...
				avatar.setViseme(ExpressionsCollection.getVisemeByAlias("U"), 1.0);
